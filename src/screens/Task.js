...
export default class Task extends Component {
    ...
    /**
    * O método _saveTaskAsync executa o método writeTaskOnFirebaseAsync disponível na classe FirebaseApi. 
    * O método writeTaskOnFirebaseAsync recebe como parâmetro um objeto que representa uma Task e 
    * nos retorna uma promessa de que a Task será criada, mas caso ocorra algum erro a promessa repassa esse erro
    */
