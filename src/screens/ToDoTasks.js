...
export default class ToDoTasks extends Component {
    ...
    /** Método _fetchTasks que, ao receber as tarefas repassadas pelo método readTaskFromFirebaseAsync, 
     * realiza um filtro somente das tarefas que não estão concluídas 
     * */
    _fetchTasks(tasks) {
